...
function createNewListItemFromValue(todoValue) 
{
	...
	newTodoInput.value = "";
	updateItemsLeft();
	localStorage.setItem(`todo ${new Date().getTime()}`, li.innerHTML);
...
const updateItemsLeft = () =>
{
	...
	const itemsCounter = document.querySelectorAll("li");
	strong.innerText = itemsCounter.length -= document.querySelectorAll("li.completed").length;
};
